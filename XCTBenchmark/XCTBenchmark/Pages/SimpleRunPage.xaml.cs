...
namespace XCTBenchmark.Pages
{
	...
	public partial class SimpleRunPage : ContentPage
	{
		public SimpleRunPage()
		{
			InitializeComponent();
		}
		...
		async void Button_Clicked(object sender, EventArgs e)
		{
			...
			try
			{
				...
				var summary = await Task.Run(() => BenchmarkRunner.Run<RegexBench>(DefaultConfig.Instance.AddLogger(logger)));
